...
local a={
	["1461157246"]={{key=Enum.KeyCode.Three,delay=0.06},{key=Enum.KeyCode.Q,delay=0.01}},
	["1461252313"]={{key=Enum.KeyCode.Three,delay=0.04},{key=Enum.KeyCode.Q,delay=0.03}},
    ["1461127258"]={{key=Enum.KeyCode.Three,delay=0.05},{key=Enum.KeyCode.Q,delay=0.02}}
}
