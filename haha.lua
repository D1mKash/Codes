...
local a={
	["1461157246"]={{key=Enum.KeyCode.Three,delay=0.05}},
	["1461252313"]={{key=Enum.KeyCode.Three,delay=0.05}},
    ["1461127258"]={{key=Enum.KeyCode.Three,delay=0.015},{key=Enum.KeyCode.Q,delay=0.05}}
}
