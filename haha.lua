...
local a={
	["1461157246"]={{key=Enum.KeyCode.Three,delay=0},{key=Enum.KeyCode.Q,delay=0.01}},
	["1461137417"]={{key=Enum.KeyCode.Three,delay=0},{key=Enum.KeyCode.Q,delay=0.01}},
	["1461252313"]={{key=Enum.KeyCode.Three,delay=0},{key=Enum.KeyCode.Q,delay=0.01}},
  ["1461127258"]={{key=Enum.KeyCode.Three,delay=0},{key=Enum.KeyCode.Q,delay=0.01}}
}
