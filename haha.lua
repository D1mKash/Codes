...
local a={
	["1461157246"]={{key=Enum.KeyCode.Three,delay=0.1}},
	["1461252313"]={{key=Enum.KeyCode.Three,delay=0.1}},
    ["1461127258"]={{key=Enum.KeyCode.Three,delay=0.01},{key=Enum.KeyCode.Q,delay=0.01},{key=Enum.KeyCode.Three,delay=0.01}}
}
