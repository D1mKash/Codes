...
local a={
	["1461157246"]={{key=Enum.KeyCode.Three,delay=0.157},{key=Enum.KeyCode.Q,delay=0.01}},
	["1461252313"]={{key=Enum.KeyCode.Three,delay=0.156},{key=Enum.KeyCode.Q,delay=0.01}},
    ["1461127258"]={{key=Enum.KeyCode.Three,delay=0.155},{key=Enum.KeyCode.Q,delay=0.01}}
}
